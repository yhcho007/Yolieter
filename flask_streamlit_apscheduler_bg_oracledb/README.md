...
```bash
pipdeptree -r -p Flask,flask_restx,APScheduler,oracledb,pandas,dash,psutil,schedule,streamlit,streamlit_autorefresh,altair,gunicorn,supervisor,mattermostdriver,flask-pyctuator
altair==5.5.0
...
├── flask-pyctuator==0.1.1 [requires: Flask>=1.1,<2.0]
...
```bash
pipdeptree -p Flask,flask_restx,APScheduler,oracledb,pandas,dash,psutil,schedule,streamlit,streamlit_autorefresh,altair,gunicorn,supervisor,mattermostdriver,flask-pyctuator   
APScheduler==3.11.0
└── tzlocal [required: >=3.0, installed: 5.3.1]
    └── tzdata [required: Any, installed: 2025.2]
dash==3.0.4
├── Flask [required: >=1.0.4,<3.1, installed: 1.1.4]
│   ├── Werkzeug [required: >=0.15,<2.0, installed: 1.0.1]
│   ├── Jinja2 [required: >=2.10.1,<3.0, installed: 2.11.3]
│   │   └── MarkupSafe [required: >=0.23, installed: 3.0.2]
│   ├── itsdangerous [required: >=0.24,<2.0, installed: 1.1.0]
│   └── click [required: >=5.1,<8.0, installed: 7.1.2]
├── Werkzeug [required: <3.1, installed: 1.0.1]
...
flask-pyctuator==0.1.1
├── Flask [required: >=1.1,<2.0, installed: 1.1.4]
│   ├── Werkzeug [required: >=0.15,<2.0, installed: 1.0.1]
│   ├── Jinja2 [required: >=2.10.1,<3.0, installed: 2.11.3]
│   │   └── MarkupSafe [required: >=0.23, installed: 3.0.2]
│   ├── itsdangerous [required: >=0.24,<2.0, installed: 1.1.0]
│   └── click [required: >=5.1,<8.0, installed: 7.1.2]
└── pyctuator [required: >=0.17.0,<0.18.0, installed: 0.17.0]
flask-restx==1.3.0
...
├── Flask [required: >=0.8,!=2.0.0, installed: 1.1.4]
│   ├── Werkzeug [required: >=0.15,<2.0, installed: 1.0.1]
│   ├── Jinja2 [required: >=2.10.1,<3.0, installed: 2.11.3]
│   │   └── MarkupSafe [required: >=0.23, installed: 3.0.2]
│   ├── itsdangerous [required: >=0.24,<2.0, installed: 1.1.0]
│   └── click [required: >=5.1,<8.0, installed: 7.1.2]
├── Werkzeug [required: !=2.0.0, installed: 1.0.1]
...
└── streamlit [required: >=0.75, installed: 1.45.1]
    ...
    ├── click [required: >=7.0,<9, installed: 7.1.2]
    ├── numpy [required: >=1.23,<3, installed: 2.2.5]
    ...
    │   │   └── MarkupSafe [required: >=0.23, installed: 3.0.2]
    │   └── numpy [required: >=1.16.4, installed: 2.2.5]
